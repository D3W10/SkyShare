...
export const boxStyles = {
    basic: "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent cursor-pointer disabled:cursor-auto",
    ...
    button: "px-4 justify-center font-medium text-slate-50 dark:text-slate-900 disabled:text-slate-50/50 disabled:dark:text-slate-900/50 bg-accent dark:bg-accent disabled:bg-slate-400 disabled:dark:bg-slate-600 inset-shadow-sm inset-shadow-slate-50/40 dark:inset-shadow-slate-50/30 enabled:hover:inset-shadow-slate-950/10 enabled:dark:hover:inset-shadow-slate-950/20 inset-ring-2 inset-ring-slate-950/15 hover:inset-ring-slate-950/5 transition duration-200 ease-in-out enabled:hover:before:border-b-0 before:border-[color:color-mix(in_oklab,var(--color-slate-950)_20%,var(--color-accent))] dark:before:border-[color:color-mix(in_oklab,var(--color-slate-950)_20%,var(--color-accent))] disabled:before:border-slate-500 disabled:dark:before:border-slate-700 before:transition-all before:duration-200 before:ease-in-out",
    secondary: "px-4 justify-center font-medium inset-shadow-sm inset-shadow-transparent enabled:hover:inset-shadow-slate-950/5 enabled:dark:hover:inset-shadow-slate-50/5 transition-shadow duration-200 ease-in-out enabled:hover:before:border-b-0 before:transition-all before:duration-200 before:ease-in-out",
