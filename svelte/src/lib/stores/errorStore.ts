...
const errorList = {
    ...
    [ErrorCode.INVALID_CODE]: "invalidCode",
    [ErrorCode.UNEXISTENT_CODE]: "unexistentCode",
    [ErrorCode.ALREADY_ANSWERED]: "alreadyAnswered",
    [ErrorCode.INVALID_ICE]: "miscommunication",
    [ErrorCode.FORBIDDEN]: "miscommunication"
};